...

{
  ...
  *(undefined4 *)(param_1 + 0xb80) = 0;
  ...
  if (uVar3 != 0) {
    ...
    ptr_00 = (undefined *)(param_1 + 0x7a8);
    iVar10 = param_1;
    do {
      if (uVar7 < 7) {
        uVar8 = (int)(uVar7 * 4) >> 2;
  ...
  if ((int)uVar6 < 4) {
    iVar10 = *(int *)(*(int *)(param_1 + 0x1c) + 0xe0);
    *(uint *)(iVar10 + 0xd0) = *(uint *)(iVar10 + 0xd0) & 0xfffffffe;
    iVar10 = *(int *)(*(int *)(param_1 + 0x1c) + 0xfc);
    *(uint *)(iVar10 + 0xd0) = *(uint *)(iVar10 + 0xd0) & 0xfffffffe;
  }
  else {
    memset_jak((undefined *)(param_1 + 0x938),0,0x28);
