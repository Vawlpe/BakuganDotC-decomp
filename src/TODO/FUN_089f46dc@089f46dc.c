...

{
  ...
  bVar1 = false;
  if (((uVar2 < 5) && (uVar2 != 1)) && (uVar2 != 3)) {
    if (uVar2 == 4) {
      bVar1 = true;
      fVar4 = *(float *)(param_1 + 100);
      fVar3 = (float)FUN_089f494c(param_1);
      *(float *)(param_1 + 100) = fVar4 - fVar3 * 0.5;
    }
    else {
      bVar1 = true;
  ...
  if (bVar1) {
    *(undefined *)(param_1 + 0xf8) = 0xc0;
    *(undefined *)(param_1 + 0xf9) = 0xc0;
    *(undefined *)(param_1 + 0x104) = 0x40;
    *(undefined *)(param_1 + 0x105) = 0xc0;
    *(undefined *)(param_1 + 0x110) = 0xc0;
