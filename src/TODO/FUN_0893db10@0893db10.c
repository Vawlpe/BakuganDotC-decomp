...

{
  ...
  *(undefined *)(param_1 + 0x74) = 0;
  memset_jak((undefined *)(param_1 + 0x75),0,2);
  memset_jak((undefined *)(param_1 + 0x7ec),0xff,0xc);
  FUN_089a4c74((undefined *)(param_1 + 0x7ec),*(undefined4 *)(param_1 + 0x7e0),
               *(undefined *)(param_1 + 0x7e4),0xff);
