...

{
  ...
  *(undefined **)(param_1 + 0x10) = &DAT_08af52f4;
  ...
  uVar1 = FUN_089d81a4();
  FUN_089d816c(1);
  ptr = (undefined *)FUN_089d7d74(0x76c,0,0);
  FUN_089d816c(uVar1);
  FUN_089d866c();
  DAT_08ac5908 = ptr;
  memset_jak(ptr,0,0x76c);
  ...
  *(undefined4 *)(DAT_08ac5908 + 0x5f0) = 0;
  ...
  do {
    iVar3 = iVar3 + 1;
    FUN_089b4c84(DAT_08ac5908 + iVar4 + 0x6b8,"%s%03d",PTR_s_BAKUGAN2_08ac58ec,iVar3);
    iVar4 = iVar4 + 0x14;
  } while (iVar3 < 8);
  *(undefined **)(DAT_08ac5908 + 0x60) = DAT_08ac5908 + 0x6b8;
  ...
  *(undefined4 *)(DAT_08ac5908 + 0x5f0) = 0;
  ...
  FUN_089d816c(uVar1);
  FUN_089d866c();
  *(undefined4 *)(DAT_08ac5908 + 0x5d4) = uVar2;
  memset_jak(*(undefined **)(DAT_08ac5908 + 0x5d4),0,0x40);
  ...
  *(undefined **)(DAT_08ac5908 + 0x5f4) = DAT_08ac5908 + 0x600;
  *(undefined4 *)(DAT_08ac5908 + 0x60c) = 8;
  *(undefined4 *)(DAT_08ac5908 + 0x610) = 0;
  *(undefined4 *)(DAT_08ac5908 + 0x614) = 1;
  *(undefined **)(DAT_08ac5908 + 0x5f8) = DAT_08ac5908 + 0x60c;
  *(undefined **)(DAT_08ac5908 + 0x5fc) = DAT_08ac5908 + 0x630;
  uVar1 = FUN_0880d2fc();
