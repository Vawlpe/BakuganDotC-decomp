...

{
  ...
  auVar3 = vmidt_q();
  uVar8 = vmov_s(*(undefined4 *)(param_1 + 0x70));
  uVar9 = vmov_s(*(undefined4 *)(param_1 + 0x74));
  uVar10 = vmov_s(0);
  ...
  *(int *)(param_1 + 0x2c) = auVar3._12_4_;
  *(int *)(param_1 + 0x30) = auVar3._16_4_;
  *(int *)(param_1 + 0x34) = auVar3._20_4_;
  *(int *)(param_1 + 0x38) = auVar3._24_4_;
  *(int *)(param_1 + 0x3c) = auVar3._28_4_;
  *(int *)(param_1 + 0x40) = auVar3._32_4_;
  *(int *)(param_1 + 0x44) = auVar3._36_4_;
  *(int *)(param_1 + 0x48) = auVar3._40_4_;
  *(int *)(param_1 + 0x4c) = auVar3._44_4_;
  *(int *)(param_1 + 0x50) = auVar3._48_4_;
  *(int *)(param_1 + 0x54) = auVar3._52_4_;
  *(int *)(param_1 + 0x58) = auVar3._56_4_;
