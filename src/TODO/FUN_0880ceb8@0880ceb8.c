...

{
  ...
  if ((undefined *)*param_1 != (undefined *)0x0) {
    memset_jak((undefined *)*param_1,0,0xed0);
    ...
    *(byte *)(*param_1 + 0x8e) = *(byte *)(*param_1 + 0x8e) | 2;
    memset_jak((undefined *)(*param_1 + 0x250),0,0x80);
    memset_jak((undefined *)(*param_1 + 0x410),0,1);
    memset_jak((undefined *)(*param_1 + 0x138),0,0x108);
    memset_jak((undefined *)(*param_1 + 0x240),0,0x10);
    memset_jak((undefined *)(*param_1 + 0x411),0,0x50);
    memset_jak((undefined *)(*param_1 + 0x2d0),0xff,0x140);
    *(undefined *)(*param_1 + 0x461) = 0;
    memset_jak((undefined *)(*param_1 + 0x42),0xff,0x3e);
