  ...
  *(undefined4 *)(iVar5 + 0x84) = 0;
  ...
  do {
    ...
    do {
      ...
      local_6f = 0;
      local_6e = 0;
      FUN_089eb2e0(&local_70,*(undefined4 *)(DAT_08aac830 + iVar6 * 4));
      if (*(char *)(param_1 + 0x89) == '\0') {
      ...
      local_68[0] = 0.0;
      local_50 = fVar8;
      FUN_08804664(iVar6,&local_6c,local_68);
      uVar3 = DAT_08b001bc;
      uVar2 = DAT_08b001b8;
      uVar1 = DAT_08b001b4;
      ...
      *(undefined4 *)(iVar4 + 0xcc) = uVar3;
      ...
      fVar8 = (float)iVar5 * 28.0 + 148.0 + 14.0;
