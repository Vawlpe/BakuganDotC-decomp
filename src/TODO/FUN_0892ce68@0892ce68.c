...

{
  ...
  memset_jak((undefined *)(param_1 + 0x1d00),0,0x28);
  ptr = (undefined *)(param_1 + 0x1d28);
  memset_jak(ptr,0,0x40);
  FUN_0892bd00(*(undefined *)(param_1 + *(char *)(param_1 + 0x75) * 0xc + 0x1ba4),ptr);
  local_28 = 0;
  FUN_089d8634();
  uVar2 = FUN_089d81a4();
  FUN_089d816c(1);
  ...
  *(uint *)(*(int *)(param_1 + 0x1cf8) + 8) =
  ...
  fVar6 = (float)FUN_0892c0dc(*(undefined *)(param_1 + *(char *)(param_1 + 0x75) * 0xc + 0x1ba4),0);
  fVar7 = (float)FUN_0892c3f8(*(undefined *)(param_1 + *(char *)(param_1 + 0x75) * 0xc + 0x1ba4),0);
  fVar6 = fVar6 * fVar7;
