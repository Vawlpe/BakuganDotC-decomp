...

{
  ...
  *(int *)(param_1 + 0x1cfc) = iVar5;
  local_30 = 0x3f19999a;
  local_2c = 0x3f19999a;
  local_28 = 0x3f19999a;
  local_24 = 0x3f800000;
  FUN_089e0344(0x41000000,iVar5,&local_30,0);
  iVar5 = *(int *)(*(int *)(param_1 + 0x1cfc) + 0x130);
  *(undefined4 *)(iVar5 + 0xa8) = 0x3ee66666;
  *(undefined4 *)(iVar5 + 0x94) = 0x3ee66666;
  *(undefined4 *)(iVar5 + 0x80) = 0x3ee66666;
  *(undefined4 *)(*(int *)(param_1 + 0x1cfc) + 0x20) = 0;
  *(undefined4 *)(*(int *)(param_1 + 0x1cfc) + 0x24) = 0xc2200000;
  iVar5 = *(int *)(param_1 + 0x1cfc);
  ...
  *(undefined4 *)(*(int *)(*(int *)(param_1 + 0x1cfc) + 0x130) + 0xbc) = 0x3f800000;
  return;
}
