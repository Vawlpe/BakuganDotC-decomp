  ...
  if (iVar15 == 0) {
    ...
    *(undefined4 *)(iVar15 + 0xbc) = uStack_84;
    ...
    if (iVar15 != 0) {
      ...
      iVar15 = local_2c;
      if (iVar17 != 0) {
        FUN_088b534c(iVar17,"fz_crystal02_break_fbx.gmo");
        iVar15 = iVar17;
      }
      ...
      *(undefined4 *)(iVar15 + 0x1c0) = 0x1e;
      FUN_089e0a70(iVar15,&LAB_088a3af8,0);
      iVar17 = FUN_089df79c(iVar15,"fz_crystal02_break__Z1");
      if (iVar17 != 0) {
        *(byte *)(iVar17 + 4) = *(byte *)(iVar17 + 4) & 0x3f | 0x40;
        *(byte *)(iVar17 + 3) = *(byte *)(iVar17 + 3) & 0xfc;
        *(byte *)(iVar17 + 3) = *(byte *)(iVar17 + 3) & 0x1f | 0xa0;
        *(byte *)(iVar17 + 4) = *(byte *)(iVar17 + 4) & 0xfc | 2;
      }
      iVar17 = FUN_089df79c(iVar15,"fz_crystal02_break__BA_Z2");
      if (iVar17 == 0) {
        iVar17 = *(int *)(param_1 + 0x350);
      }
      else {
      ...
      if (iVar17 != 0) {
        FUN_088598a8(&local_70,*(undefined4 *)(param_1 + 0x350));
        local_60 = local_70;
        uStack_5c = uStack_6c;
        uStack_58 = uStack_68;
        uStack_54 = uStack_64;
