...
void FUN_0897d79c(int param_1,char param_2)

{
  ...
  memset_jak((undefined *)(param_1 + 0x136c),0,0x10);
  *(undefined4 *)(param_1 + 0x1370) = 0x4048f5c3;
  *(undefined4 *)(param_1 + 0x1378) = 0x3f800000;
  iVar6 = *(int *)(*(int *)(param_1 + *(char *)(param_1 + 0x1318) * 4 + 0x12a4) + 0x130);
  ...
  *(int *)(iVar6 + 0xbc) = auVar3._60_4_;
  if (param_2 == '\0') {
    fVar7 = (float)FUN_0897c7b4(param_1,*(undefined *)(param_1 + 0x1318));
    fVar7 = fVar7 * 1.4;
    param_1 = param_1 + *(char *)(param_1 + 0x1318) * 4;
    *(float *)(param_1 + 0x137c) = fVar7;
    iVar6 = *(int *)(*(int *)(param_1 + 0x12a4) + 0x130);
    ...
    *(int *)(iVar6 + 0xac) = auVar4._12_4_;
    ...
    FUN_0897d5c8(auStack_20,param_1);
    fVar7 = (float)FUN_0897c7b4(param_1,*(undefined *)(param_1 + 0x1318));
    fVar7 = fVar7 * local_1c;
    param_1 = param_1 + *(char *)(param_1 + 0x1318) * 4;
    *(float *)(param_1 + 0x137c) = fVar7;
    iVar6 = *(int *)(*(int *)(param_1 + 0x12a4) + 0x130);
    auVar1 = vscl_q(*(undefined (*) [16])(iVar6 + 0x80),fVar7);
