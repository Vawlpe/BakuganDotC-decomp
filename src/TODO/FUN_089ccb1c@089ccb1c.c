  ...
  *(uint *)(param_1 + 0x14) = param_2;
  if (param_2 < 0xf) {
      ...
      *(undefined4 *)(DAT_08ac5908 + 0x5c8) = 3;
      ...
      if (iVar4 != 0) {
        ...
        *(undefined4 *)(iVar1 + 0x588) = uVar2;
        iVar1 = DAT_08ac5908;
        ptr = (undefined4 *)(DAT_08ac5908 + 0x69c);
        memset_jak((undefined *)ptr,0,0x14);
        *(undefined4 **)(DAT_08ac5908 + 0x5c4) = ptr;
        *ptr = *(undefined4 *)(iVar4 + 4);
        uVar2 = *(undefined4 *)(iVar4 + 8);
    ...
    default:
      ...
      memset_jak((undefined *)(DAT_08ac5908 + 100),0,0xd);
    ...
    case 0xd:
      *(undefined4 *)(DAT_08ac5908 + 0x30) = 1;
      ...
      if ((iVar4 < 0) || (8 < iVar4)) {
        ...
        memset_jak((undefined *)(DAT_08ac5908 + 0x4c),0,0x14);
