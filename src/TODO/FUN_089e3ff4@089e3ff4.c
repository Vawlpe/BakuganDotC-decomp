...
void FUN_089e3ff4(int param_1,int param_2,undefined4 param_3)

{
  ...
  iVar1 = FUN_089e9a3c(param_2,param_3);
  if (iVar1 != 0) {
    local_40[0] = INFINITY;
    if (*(int *)(param_2 + 0x20) == 0) {
      FUN_089e3ff4(param_1,*(undefined4 *)(param_2 + 0x28),param_3);
      FUN_089e3ff4(param_1,*(undefined4 *)(param_2 + 0x2c),param_3);
    }
    else {
      iVar1 = 0;
      if (0 < *(int *)(param_2 + 0x20)) {
        ...
        do {
          ...
          if ((uVar3 == 0xffffffff) || ((1 << (uVar3 & 0x1f) & DAT_08af8380) != 0)) {
            iVar2 = FUN_089e3e00(param_1,iVar4,local_34,local_40);
            if (iVar2 == 0) {
