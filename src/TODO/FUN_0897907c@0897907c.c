...

{
  ...
  *(undefined *)(param_1 + 0xee4) = 0;
  FUN_08978998();
  memset_jak((undefined *)(param_1 + 0x1300),0,0xc);
  memset_jak((undefined *)(param_1 + 0x130c),0,0xc);
  memset_jak((undefined *)(param_1 + 0x12a4),0,0x1c);
  iVar6 = 0;
  iVar5 = param_1;
  do {
    FUN_089d8634();
  ...
  memset_jak((undefined *)(param_1 + 0x12c0),0,7);
  memset_jak((undefined *)(param_1 + 0x132c),0,0x40);
  ...
  memset_jak((undefined *)(param_1 + 0xef0),0,0x20);
  memset_jak((undefined *)(param_1 + 0xf10),0,0x224);
