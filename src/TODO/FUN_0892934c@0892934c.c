...

{
  ...
  if (*(float *)(param_1 + 0x4cc) == 0.0) {
  ...
  else if (*(float *)(param_1 + 0x4c8) == *(float *)(param_1 + 0x4c4)) {
    iVar3 = *(int *)(param_1 + 0x4c0);
  }
  else {
    ...
    if (0.0 < *(float *)(param_1 + 0x4cc)) {
      do {
        iVar3 = iVar3 + 1;
        *(undefined4 *)(iVar4 + 0xbc) = *(undefined4 *)(param_1 + 0x4c4);
        iVar4 = *(int *)(iVar4 + 4);
      } while ((float)iVar3 < *(float *)(param_1 + 0x4cc));
    }
    *(undefined4 *)(param_1 + 0x4c8) = *(undefined4 *)(param_1 + 0x4c4);
    iVar3 = *(int *)(param_1 + 0x4c0);
  }
  uVar1 = DAT_08b0019c;
  uVar5 = DAT_08b00198;
