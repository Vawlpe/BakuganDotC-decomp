...

{
  ...
  *(int *)(param_1 + 0x918) = iVar5;
  ...
  iVar5 = *(int *)(*(int *)(param_1 + 0x918) + 0x130);
  *(undefined4 *)(iVar5 + 0xa8) = 0x3ee66666;
  *(undefined4 *)(iVar5 + 0x94) = 0x3ee66666;
  *(undefined4 *)(iVar5 + 0x80) = 0x3ee66666;
  *(undefined4 *)(*(int *)(param_1 + 0x918) + 0x20) = 0;
  *(undefined4 *)(*(int *)(param_1 + 0x918) + 0x24) = 0xc2200000;
  iVar5 = *(int *)(param_1 + 0x918);
  ...
  *(undefined4 *)(*(int *)(*(int *)(param_1 + 0x918) + 0x130) + 0xbc) = 0x3f800000;
  return;
}
