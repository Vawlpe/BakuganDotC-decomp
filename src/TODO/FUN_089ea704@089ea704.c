...
undefined4 FUN_089ea704(int param_1,int param_2,undefined4 *param_3)

{
  ...
  if (DAT_08af8670 == 0) {
    DAT_08af8670 = 1;
    DAT_08af8684 = &DAT_08af5624;
    DAT_08af8694 = &DAT_08af5564;
    DAT_08af8690 = 2;
    DAT_08af8680 = 4;
  }
  ...
  (**(code **)(iVar6 + 0x34))
            (param_2 + *(short *)(iVar6 + 0x30),(undefined4 *)(param_1 + 0x70),&DAT_08af8680);
  iVar6 = FUN_089ea118(param_1 + 0x10,&DAT_08af8680,param_3);
  if (iVar6 != 0) {
    uVar7 = vfim_s(0x3c00);
