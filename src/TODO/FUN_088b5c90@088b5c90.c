...
void FUN_088b5c90(float param_1,float param_2,int param_3,undefined4 *param_4,undefined4 *param_5)

{
  ...
  *(undefined4 *)(param_3 + 0x6c) = uVar18;
  memset_jak((undefined *)(param_3 + 0x14c),0,0x20);
  ...
  *(float *)(param_3 + 0x1b4) = *(float *)(param_3 + 0x1b4) + 3.0;
  local_5c = puVar23;
  FUN_089d8634();
  uVar16 = FUN_089d81a4();
  FUN_089d816c(1);
  ...
  FUN_089d816c(uVar16);
  FUN_089d866c();
  local_54 = *(int *)(param_3 + 0xec);
  *(undefined4 *)(param_3 + 0x1c8) = uVar17;
  local_50 = 0;
  iVar20 = local_54 * 0x170;
  FUN_089d8634();
  uVar16 = FUN_089d81a4();
  FUN_089d816c(1);
  local_58 = FUN_089d7d74(iVar20 + 0x10,0,0);
  FUN_089d816c(uVar16);
  FUN_089d866c();
  uVar16 = local_50;
  if (local_58 != 0) {
    uVar16 = FUN_08a02cb4(local_58 + DAT_08af1178,local_54,0x170,FUN_089e681c,0);
  }
  *(undefined4 *)(param_3 + 0x19c) = uVar16;
  ...
  if (DAT_08af8020 == 0) {
    DAT_08af8020 = 1;
    DAT_08af8030 = 0x41400000;
    DAT_08af8034 = 0;
    DAT_08af8038 = 0x41400000;
    DAT_08af803c = 0;
  }
  iVar20 = 0;
  if (0 < *(int *)(param_3 + 0xec)) {
    local_64 = &DAT_08b001a0;
    local_60 = (undefined (*) [12])&DAT_08af8030;
    iVar22 = 0;
    local_4c = 0;
    ...
    do {
      ...
      *(float *)(*(int *)(param_3 + 0x19c) + iVar22 + 0x104) = param_1 - (local_ac + local_bc) * 0.5
      ;
      *(undefined4 *)(*(int *)(param_3 + 0x19c) + iVar22 + 0x10c) = 0x3f19999a;
      ...
      uVar18 = vmul_s(uVar18,fVar25);
      auVar1 = vscl_t(auVar1,uVar18);
      if (DAT_08b00150 == 0) {
        DAT_08b00150 = 1;
        DAT_08b00140 = 0x3fc00000;
        *(undefined4 *)((int)*local_48 + 4) = 0x3fc00000;
        *(undefined4 *)((int)*local_48 + 8) = 0x3fc00000;
        *(undefined4 *)local_48[1] = 0;
      }
      auVar2 = vrndf1_t();
      auVar2 = vsub_t(auVar2,*local_48);
      ...
      auVar1 = vscl_t(auVar1,0x41f00000);
