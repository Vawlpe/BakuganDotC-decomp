...

{
  undefined4 uVar1;
  int iVar2;
  config_buffer *pcVar3;
  int iVar4;
  config_buffer *weird_buff;
  ...
  *(undefined *)((int)param_1 + 0xdd) = 0;
  ...
  uVar1 = FUN_089d81a4();
  FUN_089d816c(1);
  pcVar3 = (config_buffer *)FUN_089d7d74(0x50,0,0);
  FUN_089d816c(uVar1);
  FUN_089d866c();
  weird_buff = (config_buffer *)0x0;
  if (pcVar3 != (config_buffer *)0x0) {
    FUN_089cdf1c(pcVar3);
    weird_buff = pcVar3;
  }
  param_1[0x39] = (int)weird_buff;
  WIP_WeirdBuff_PrepReadCtrl(weird_buff,0);
