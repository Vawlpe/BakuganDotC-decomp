...
undefined4 FUN_088ff80c(undefined4 param_1,undefined4 *param_2,int *param_3)

{
  ...
  if (iVar8 != 0) {
    local_250 = param_2;
    FUN_088fe948(&local_40);
    DAT_08b00ff0 = local_40;
    DAT_08b00ff4 = uStack_3c;
    DAT_08b00ff8 = uStack_38;
    DAT_08b00ffc = uStack_34;
