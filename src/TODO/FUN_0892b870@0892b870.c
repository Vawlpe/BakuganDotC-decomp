...

{
  ...
  if (*(int *)(param_1 + 0x18) != 0) {
    ...
    FUN_089f5084(*(undefined4 *)(param_1 + 0x18),uVar3);
    uVar3 = FUN_089f2178(0x43960000);
    FUN_089f5474(*(undefined4 *)(param_1 + 0x18),4);
    FUN_089f5084(*(undefined4 *)(param_1 + 0x18),uVar3);
  }
  if (*(int *)(param_1 + 0x1cfc) != 0) {
    uVar3 = FUN_089f2178(0x42700000);
    local_40[0] = (uint *)FUN_089f1308(uVar3);
    local_40[0] = (uint *)FUN_089f1490(local_40[0],*(undefined4 *)(param_1 + 0x1cf4),1);
    local_2c = 0.0;
    fVar5 = DAT_08b0019c;
    if (1.0 < DAT_08b0019c) {
      fVar5 = 1.0;
    ...
    *local_40[0] = uVar6;
    ...
    iVar4 = *(int *)(*(int *)(param_1 + 0x1cfc) + 0x14);
    (**(code **)(iVar4 + 0x44))(*(int *)(param_1 + 0x1cfc) + (int)*(short *)(iVar4 + 0x40),local_40)
    ;
  ...
  if (*(int *)(param_1 + 0x1cf8) != 0) {
    ...
    *local_40[0] = uVar6;
    ...
    (**(code **)(iVar4 + 0x44))(*(int *)(param_1 + 0x1cf8) + (int)*(short *)(iVar4 + 0x40),local_40)
    ;
    FUN_089f13c8(uVar3,local_40[0]);
  }
  return;
