...
void FUN_088ba5c8(int param_1,int param_2)

{
  ...
  *(undefined4 *)(param_1 + 0x2f4) = 0;
  fVar5 = (float)atan2f(*(float *)(param_2 + 0x28) - *(float *)(*(int *)(param_1 + 0x2a0) + 0x28),
                        *(float *)*(undefined (*) [12])(param_2 + 0x20) -
                        *(float *)(*(int *)(param_1 + 0x2a0) + 0x20));
...
LAB_088ba838:
  ...
  auVar1 = vsub_t(*(undefined (*) [12])(param_2 + 0x20),*(undefined (*) [12])(iVar4 + 0x20));
