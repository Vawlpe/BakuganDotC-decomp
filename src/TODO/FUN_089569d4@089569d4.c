...

{
  ...
  *(undefined *)(param_1 + 0x4cdc) = 0;
  ...
  memset_jak((undefined *)(param_1 + 0x4d08),0,0x10);
  memset_jak((undefined *)(param_1 + 0x4d18),0,0x10);
  memset_jak((undefined *)(param_1 + 0x4d28),0,4);
  ...
  memset_jak((undefined *)(param_1 + 0x4f34),0,0x30);
  memset_jak((undefined *)(param_1 + 0x4f74),0,4);
  if (*(char *)(param_1 + 0x4cda) < '\x03') {
    uVar2 = 2;
    iVar4 = FUN_0880d354();
    if (iVar4 != 0) {
  ...
  memset_jak((undefined *)(param_1 + 0x4f84),0,0xc);
  *(undefined4 *)(param_1 + 0x4f8c) = 0x3f800000;
  memset_jak((undefined *)(param_1 + 0x4fb0),0,4);
  if (DAT_08ac0e78 == 300) {
    FUN_089564e4();
  }
