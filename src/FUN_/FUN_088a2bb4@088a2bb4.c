...

{
  ...
  *(undefined4 *)(param_1 + 0x148) = 0;
  ...
  if (*(int *)(param_1 + 0x148) == 0) {
    iVar8 = *(int *)(param_1 + 0x32c);
  }
  else {
    if (*(int *)(*(int *)(param_1 + 0x148) + 0x268) == 2) {
      if (*(int *)(param_1 + 800) == 0) {
        return;
      }
  ...
  if (iVar8 == 0) {
    ...
    if ((float)iVar8 <= 0.0) {
      ...
      *(int *)(param_1 + 0x380) = auVar2._0_4_;
      *(int *)(param_1 + 900) = auVar2._4_4_;
      *(int *)(param_1 + 0x388) = auVar2._8_4_;
      *(int *)(param_1 + 0x38c) = auVar3._12_4_;
      *(undefined *)(param_1 + 0x2b1) = 0;
