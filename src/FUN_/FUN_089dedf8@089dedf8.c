...
void FUN_089dedf8(int param_1,undefined4 *param_2,undefined4 param_3)

{
  ...
  iVar6 = FUN_089dec38(param_1,param_3);
  uVar5 = DAT_08b007dc;
  uVar4 = DAT_08b007d8;
  uVar3 = DAT_08b007d4;
  if (-1 < iVar6) {
    iVar6 = FUN_08a15948(*(undefined4 *)(param_1 + 0x130),iVar6);
    ...
    auVar2._60_4_ = *(undefined4 *)(iVar6 + 0xbc);
    auVar2._56_4_ = *(undefined4 *)(iVar6 + 0xac);
    auVar2._52_4_ = *(undefined4 *)(iVar6 + 0x9c);
    auVar2._48_4_ = *(undefined4 *)(iVar6 + 0x8c);
    auVar2._44_4_ = *(undefined4 *)(iVar6 + 0xb8);
    auVar2._40_4_ = *(undefined4 *)(iVar6 + 0xa8);
    auVar2._36_4_ = *(undefined4 *)(iVar6 + 0x98);
    auVar2._32_4_ = *(undefined4 *)(iVar6 + 0x88);
    auVar2._28_4_ = *(undefined4 *)(iVar6 + 0xb4);
    auVar2._24_4_ = *(undefined4 *)(iVar6 + 0xa4);
    auVar2._20_4_ = *(undefined4 *)(iVar6 + 0x94);
    auVar2._16_4_ = *(undefined4 *)(iVar6 + 0x84);
    auVar2._12_4_ = *(undefined4 *)(iVar6 + 0xb0);
    auVar2._8_4_ = *(undefined4 *)(iVar6 + 0xa0);
    auVar2._4_4_ = *(undefined4 *)(iVar6 + 0x90);
    auVar2._0_4_ = *(undefined4 *)(iVar6 + 0x80);
