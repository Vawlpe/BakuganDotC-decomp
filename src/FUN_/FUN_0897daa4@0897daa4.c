...
// WARNING: Removing unreachable block (ram,0x0897db30)

void FUN_0897daa4(int param_1,byte param_2,uint param_3,int param_4)

{
  ...
  memcpy_jak(auStack_d0,&PTR_s_00_dor_dir_popout_08ac3770,0x84);
  memcpy_jak(auStack_4c,&PTR_s_00_M_Dragonoid_N_P_fencer2_08ac37f4,0x34);
