...

{
  ...
  *(undefined *)(param_1 + 0xe7c) = 0;
  FUN_0898ad80();
  memset_jak(param_1 + 0x1258,0,0xc);
  memset_jak(param_1 + 0x1264,0,0xc);
  memset_jak(param_1 + 0x1208,0,0x18);
  iVar6 = 0;
  iVar5 = param_1;
  do {
    FUN_089d8634();
  ...
  memset_jak(param_1 + 0xe88,0,0x20);
  memset_jak(param_1 + 0xea8,0,0x224);
