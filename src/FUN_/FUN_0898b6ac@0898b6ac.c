...

{
  ...
  if (*(int *)(param_1 + 0xea8) != 0) {
    if (*(float *)(param_1 + 0xeb4) == 0.0) {
      iVar3 = *(int *)(param_1 + 0xea8);
    }
    else if (*(float *)(param_1 + 0xeac) == *(float *)(param_1 + 0xeb0)) {
      iVar3 = *(int *)(param_1 + 0xea8);
    }
    else {
      ...
      if (0.0 < *(float *)(param_1 + 0xeb4)) {
        do {
          iVar3 = iVar3 + 1;
          *(undefined4 *)(iVar4 + 0xbc) = *(undefined4 *)(param_1 + 0xeac);
          iVar4 = *(int *)(iVar4 + 4);
        } while ((float)iVar3 < *(float *)(param_1 + 0xeb4));
      }
      *(undefined4 *)(param_1 + 0xeb0) = *(undefined4 *)(param_1 + 0xeac);
      iVar3 = *(int *)(param_1 + 0xea8);
    }
    uVar1 = DAT_08b0019c;
    uVar5 = DAT_08b00198;
