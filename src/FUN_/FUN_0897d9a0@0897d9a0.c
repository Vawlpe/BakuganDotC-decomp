...
// WARNING: Removing unreachable block (ram,0x0897da2c)

void FUN_0897d9a0(int param_1,byte param_2,uint param_3,int param_4)

{
  ...
  memcpy_jak(auStack_d0,&PTR_s_00_dor_dir_popout_08ac36b8,0x84);
  memcpy_jak(auStack_4c,&PTR_s_00_M_Dragonoid_N_P_fencer2_motio_08ac373c,0x34);
