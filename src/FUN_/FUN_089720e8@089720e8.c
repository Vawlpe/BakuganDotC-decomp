...

{
  ...
  *(undefined4 *)(param_1 + 0xbb4) = 0;
  ...
  if ((int)uVar2 < 4) {
    iVar9 = *(int *)(*(int *)(param_1 + 0x1c) + 0xd0);
    *(uint *)(iVar9 + 0xd0) = *(uint *)(iVar9 + 0xd0) & 0xfffffffe;
    iVar9 = *(int *)(*(int *)(param_1 + 0x1c) + 0xe8);
    *(uint *)(iVar9 + 0xd0) = *(uint *)(iVar9 + 0xd0) & 0xfffffffe;
  }
  else {
    memset_jak(param_1 + 0x898,0,0x28);
    iVar9 = *(int *)(*(int *)(param_1 + 0x1c) + 0xd0);
