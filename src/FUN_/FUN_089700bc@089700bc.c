...

{
  ...
  if (*(int *)(param_1 + 0x18) != 0) {
    ...
    if (*(char *)(param_1 + 0xb8c) != '\0') {
      local_20 = 0;
      local_1c = 0;
      local_18 = 0x43f00000;
      local_14 = 0x43880000;
      uVar1 = FUN_089f2178(0x44898000);
      ...
      local_24 = *(undefined4 *)(param_1 + 0xb90);
      local_30 = 0;
      local_2c = 0;
      local_28 = 0;
    ...
    uVar1 = FUN_089f2178(0x44960000);
    FUN_089f5084(*(undefined4 *)(param_1 + 0x18),uVar1);
  }
  FUN_0896fff4(param_1);
  return;
}
