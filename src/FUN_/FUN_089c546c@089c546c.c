  ...
  if (*(char *)(param_1 + 0xd) == '\0') {
    if (*(char *)(param_1 + 1) == '\0') {
      ...
      if ((iVar3 == 2) || (iVar3 == 6)) {
        ...
        iVar6 = param_1[7];
        iVar3 = FUN_089c59f0();
        iVar6 = iVar6 + *(int *)(iVar3 + 4) * param_1[8];
        iVar3 = FUN_089d5814();
        if (iVar3 != 0) {
          uVar8 = FUN_089d5830();
        ...
        if (bVar1) {
          uVar8 = FUN_089d5830();
          puVar5 = (undefined4 *)FUN_089c59f0();
          FUN_089d5e7c(uVar8,iVar6,*puVar5);
          iVar3 = param_1[9];
        }
        else {
          iVar3 = FUN_089c59f0();
          memset_jak(iVar6,0,*(undefined4 *)(iVar3 + 4));
          iVar3 = param_1[9];
        }
        param_1[9] = iVar3 + 1;
      }
        ...
        iVar7 = param_1[8];
        iVar3 = FUN_089c59f0();
        memset_jak(iVar9 + iVar6 * iVar7,0,*(undefined4 *)(iVar3 + 4));
      ...
      if (*(char *)((int)param_1 + 5) == '\0') {
        ...
        uVar4 = param_1[7];
        iVar3 = FUN_089c59f0();
        memset_jak(uVar4,0,*(int *)(iVar3 + 4) * 2);
        memset_jak(param_1[10],0,0x2000);
        param_1[9] = 0;
        param_1[8] = 0;
