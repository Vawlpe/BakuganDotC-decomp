...
void FUN_088242dc(int param_1,int param_2,undefined4 *param_3)

{
  ...
  *(undefined4 **)(iVar17 + 0x164) = param_3;
  *(undefined4 *)(iVar17 + 0x180) = in_V73;
  *(undefined4 *)(iVar17 + 0x184) = in_V77;
  *(undefined4 *)(iVar17 + 0x188) = in_V7B;
  *(undefined4 *)(iVar17 + 0x18c) = in_V7F;
  return;
}
