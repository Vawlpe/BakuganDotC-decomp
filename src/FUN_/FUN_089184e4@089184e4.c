...

{
  ...
  memset_jak(param_1 + 0x91c,0,0x28);
  iVar6 = param_1 + 0x944;
  memset_jak(iVar6,0,0x40);
  FUN_0892bd00(*(undefined *)(param_1 + *(char *)(param_1 + 0x74) * 4 + 0x8a0),iVar6);
  local_28 = 0;
  FUN_089d8634();
  uVar2 = FUN_089d81a4();
  FUN_089d816c(1);
  ...
  *(uint *)(*(int *)(param_1 + 0x914) + 8) =
  ...
  fVar7 = (float)FUN_0892c0dc(*(undefined *)(param_1 + *(char *)(param_1 + 0x74) * 4 + 0x8a0),0);
  fVar8 = (float)FUN_0892c3f8(*(undefined *)(param_1 + *(char *)(param_1 + 0x74) * 4 + 0x8a0),0);
  fVar7 = fVar7 * fVar8;
