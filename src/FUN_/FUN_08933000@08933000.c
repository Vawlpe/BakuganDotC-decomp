...

{
  ...
  memset_jak(param_1 + 0x1a88,0,0x28);
  iVar8 = param_1 + 0x1ab0;
  memset_jak(iVar8,0,0x40);
  piVar2 = (int *)FUN_0880cc48();
  uVar7 = *(uint *)(*piVar2 + 0x48c) & 0xff;
  FUN_0892bd00(uVar7,iVar8);
  local_28 = 0;
  FUN_089d8634();
  uVar3 = FUN_089d81a4();
  FUN_089d816c(1);
  ...
  *(int *)(param_1 + 0x1a80) = iVar5;
  FUN_089e0860();
  FUN_089b4c84(auStack_70,"%s.gmo",iVar8);
  uVar3 = FUN_089d9674();
  FUN_089d9914(uVar3,auStack_70);
  uVar6 = *(undefined4 *)(param_1 + 0x1a80);
  uVar3 = FUN_089d9674();
  uVar3 = FUN_089d9c84(uVar3,iVar8);
  ...
  *(uint *)(*(int *)(param_1 + 0x1a80) + 8) = uVar7;
  ...
  fVar9 = (float)FUN_0892c0dc(uVar7,0);
  fVar10 = (float)FUN_0892c3f8(uVar7,0);
  fVar9 = fVar9 * fVar10 * 0.6;
  *(float *)(iVar5 + 0xa8) = fVar9;
  *(float *)(iVar5 + 0x94) = fVar9;
  *(float *)(iVar5 + 0x80) = fVar9;
