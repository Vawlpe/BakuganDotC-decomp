...

{
  ...
  uVar8 = vmul_s(*(undefined4 *)(param_1 + 0x1370),in_V7C);
  ...
  *(int *)(iVar6 + 0xbc) = auVar2._12_4_;
  iVar6 = *(int *)(*(int *)(param_1 + *(char *)(param_1 + 0x1318) * 4 + 0x12a4) + 0x130);
  uVar8 = vmul_s(*(undefined4 *)(param_1 + 0x136c),in_V7C);
  auVar1 = vidt_q();
  ...
  *(int *)(iVar6 + 0xbc) = auVar3._60_4_;
  FUN_0897d5c8(auStack_18,param_1);
  fVar7 = (float)FUN_0897c7b4(param_1,*(undefined *)(param_1 + 0x1318));
  fVar7 = fVar7 * local_14 * *(float *)(param_1 + 0x1378);
