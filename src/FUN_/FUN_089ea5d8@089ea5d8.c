...
undefined4 FUN_089ea5d8(int param_1,int param_2,undefined4 *param_3)

{
  ...
  (**(code **)(iVar6 + 0x34))
            (param_2 + *(short *)(iVar6 + 0x30),(undefined4 *)(param_1 + 0x70),&DAT_08af8640);
  iVar6 = FUN_089ea060(param_1 + 0x10,&DAT_08af8640,param_3);
  if (iVar6 != 0) {
    uVar7 = vfim_s(0x3c00);
