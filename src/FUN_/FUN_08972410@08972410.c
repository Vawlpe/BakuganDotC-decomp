...
undefined4 FUN_08972410(int param_1)

{
  ...
  iVar4 = *(int *)(*(int *)(param_1 + 0x1c) +
                   *(char *)(param_1 + 0x74) * 0xc + (uint)*(byte *)(param_1 + 3000) * 0x30 + 4);
  if (iVar2 != 0) {
    ...
    while( true ) {
      *(undefined4 *)
       (*(int *)(*(int *)(param_1 + 0x1c) +
                 (iVar2 + cVar1 * 3) * 4 + (uint)*(byte *)(param_1 + 3000) * 0x30 + 4) + 0x90) =
           0x3f800000;
      iVar4 = *(int *)(*(int *)(param_1 + 0x1c) +
                       (iVar2 + *(char *)(param_1 + 0x74) * 3) * 4 +
                       (uint)*(byte *)(param_1 + 3000) * 0x30 + 4);
      *(undefined4 *)(iVar4 + 0x94) = *(undefined4 *)(iVar4 + 0x90);
      *(undefined4 *)
       (*(int *)(*(int *)(param_1 + 0x1c) +
                 (iVar2 + *(char *)(param_1 + 0x74) * 3) * 4 +
                 (uint)*(byte *)(param_1 + 3000) * 0x30 + 4) + 0x9c) = 0;
      iVar4 = *(int *)(*(int *)(param_1 + 0x1c) +
                       (iVar2 + *(char *)(param_1 + 0x74) * 3) * 4 +
                       (uint)*(byte *)(param_1 + 3000) * 0x30 + 4);
  ...
  *(undefined4 *)(iVar4 + 0xb8) = 0x3e99999a;
  ...
  while( true ) {
    pfVar3 = (float *)(*(int *)(*(int *)(param_1 + 0x1c) +
                                (iVar2 + cVar1 * 3) * 4 + (uint)*(byte *)(param_1 + 3000) * 0x30 + 4
                               ) + 0x90);
    *pfVar3 = *pfVar3 + 0.1;
    iVar4 = *(int *)(*(int *)(param_1 + 0x1c) +
                     (iVar2 + *(char *)(param_1 + 0x74) * 3) * 4 +
    ...
    *(undefined4 *)
     (*(int *)(*(int *)(param_1 + 0x1c) +
               (iVar2 + *(char *)(param_1 + 0x74) * 3) * 4 + (uint)*(byte *)(param_1 + 3000) * 0x30
              + 4) + 0x9c) = 0;
    iVar4 = *(int *)(*(int *)(param_1 + 0x1c) +
                     (iVar2 + *(char *)(param_1 + 0x74) * 3) * 4 +
                     (uint)*(byte *)(param_1 + 3000) * 0x30 + 4);
